...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <h1 style={headingStyle}>{currentMonthYear}</h1>
      ...
      <div class="row" style={{ height: 250 }}>
        ...
        <div class="col-sm-8 bg-secondary p-4 my-4 border">
          ...
          <div style={{ width: "500px", height: "150px", marginLeft: "20px" }}>
      ...
      <div class="container mt-4">
        <h2 class="text-center" style={{ marginBottom: 0 }}>
          Categories
        </h2>
        <br />
        <div class="d-flex justify-content-center">
          <div class="btn-group" role="group">
            <button
              ...
              onClick={() => handleRedirect("/transactions/food")}
            >
              Food
            </button>
            <button
              type="button"
              class="btn btn-outline-secondary btn-lg"
              onClick={() => handleRedirect("/transactions/bills")}
            >
              Bills
            </button>
            <button
              type="button"
              class="btn btn-outline-secondary btn-lg"
              onClick={() => handleRedirect("/transactions/transport")}
            >
              Transport
            </button>
            <button
              type="button"
              class="btn btn-outline-secondary btn-lg"
              onClick={() => handleRedirect("/transactions/healthcare")}
            >
              Healthcare
            </button>
            <button
              type="button"
              class="btn btn-outline-secondary btn-lg"
              onClick={() => handleRedirect("//transactions/house")}
            >
              House
            </button>
            <button
              type="button"
              class="btn btn-outline-secondary btn-lg"
              onClick={() => handleRedirect("/transactions/savings")}
            >
              Savings
            </button>
          </div>
        ...
        <div class="d-flex justify-content-center">
          <button
            ...
            onClick={() => handleRedirect("/add_transaction")}
          >
            +Add New Transaction
          </button>
        </div>
